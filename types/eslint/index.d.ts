...
import type { Prepend } from './helpers';
...
export namespace Linter {
    ...
    interface BaseConfig<Rules extends RulesRecord = RulesRecord> extends HasRules<Rules> {
        ...
        overrides?: Array<ConfigOverride<Rules>>;
        parser?: string;
...
// import type ESLintRules from './rules';
// export { ESLintRules };
export type { default as ESLintRules } from './rules';
// import * as AllRules from './rules';
// export namespace RRules {
//     export type BestPractices = AllRules.BestPractices;
//     type Deprecated = AllRules.Deprecated;
//     type ECMAScript6 = AllRules.ECMAScript6;
//     type NodeJSAndCommonJS = AllRules.NodeJSAndCommonJS;
//     type PossibleErrors = AllRules.PossibleErrors;
//     type StrictMode = AllRules.StrictMode;
//     type StylisticIssues = AllRules.StylisticIssues;
//     type Variables = AllRules.Variables;
//     type All = AllRules.default;
// }
